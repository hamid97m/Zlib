//
// Created by AmirHossein Aghajari on 10/25/22.
//
...
Java_com_google_archivepatcher_applier_zip_CustomDeflater_test(JNIEnv *env, jclass cls, int a)
{
    return a * 2;
}
...
Java_com_google_archivepatcher_applier_zip_CustomDeflater_initIDs(JNIEnv *env, jclass cls)
{
...
Java_com_google_archivepatcher_applier_zip_CustomDeflater_init(JNIEnv *env, jclass cls, jint level,
...
JNIEXPORT void JNICALL
Java_com_google_archivepatcher_applier_zip_CustomDeflater_setDictionary(JNIEnv *env, jclass cls, jlong addr,
...
Java_com_google_archivepatcher_applier_zip_CustomDeflater_deflateBytes(JNIEnv *env, jobject this, jlong addr,
...
JNIEXPORT jint JNICALL
Java_com_google_archivepatcher_applier_zip_CustomDeflater_getAdler(JNIEnv *env, jclass cls, jlong addr)
{
    return ((z_stream *)jlong_to_ptr(addr))->adler;
}

JNIEXPORT void JNICALL
Java_com_google_archivepatcher_applier_zip_CustomDeflater_reset(JNIEnv *env, jclass cls, jlong addr)
{
...
JNIEXPORT void JNICALL
Java_com_google_archivepatcher_applier_zip_CustomDeflater_end(JNIEnv *env, jclass cls, jlong addr)
{
